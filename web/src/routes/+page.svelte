...
<div class="hero">
	...
	<div class="get-mod">
		<h2>Get the Mod</h2>
		<div class="os-links">
			<a href="https://github.com/jphastings/slay-the-spire-ii-atproto/releases/latest/download/atproto-tracker-installer-osx-arm64.zip" title="Download for macOS (Apple Silicon) — tested" class="tested">
			...
			<a href="https://github.com/jphastings/slay-the-spire-ii-atproto/releases/latest/download/atproto-tracker-installer-win-x64.exe" aria-label="Download for Windows — not yet tested" data-tooltip="Not yet tested" class="untested">
			...
			<a href="https://github.com/jphastings/slay-the-spire-ii-atproto/releases/latest/download/atproto-tracker-installer-linux-x64" title="Download for Linux — tested" class="tested">
			...
			<a href="https://github.com/jphastings/slay-the-spire-ii-atproto#readme" title="Source on GitHub" class="info-link">
	...
	<div class="links">
		...
		>
			<svg class="btn-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path d="M.329 10.333A8.01 8.01 0 0 0 7.95 16C12.4 16 16 12.418 16 8s-3.6-8-8.05-8C3.756 0 .228 3.385 0 7.68l4.326 1.757a2.26 2.26 0 0 1 1.348-.432l1.978-2.02v-.04c0-1.7 1.396-3.085 3.101-3.085 1.712 0 3.101 1.39 3.101 3.086 0 1.697-1.39 3.086-3.1 3.086h-.076l-2.01 1.41c0 .04.007.082.007.123 0 1.245-1.013 2.257-2.26 2.257-1.08 0-1.99-.77-2.214-1.78zM4.093 11.21l-1.297-.53a2.45 2.45 0 0 0 1.275 1.273 2.4 2.4 0 0 0 1.839.006 2.44 2.44 0 0 0 1.3-1.27 2.4 2.4 0 0 0 .004-1.829 2.43 2.43 0 0 0-1.28-1.286 2.41 2.41 0 0 0-1.74-.046L6.275 8.07A1.784 1.784 0 1 1 4.093 11.21m11.034-4.23a2.047 2.047 0 0 0-1.112-2.68 2.06 2.06 0 0 0-1.583-.002 2.07 2.07 0 0 0-1.116 1.113 2.05 2.05 0 0 0 1.123 2.677 2.07 2.07 0 0 0 2.688-1.108M10.92 6.55a1.55 1.55 0 0 1 .842-2.026 1.55 1.55 0 0 1 2.033.838 1.544 1.544 0 0 1-.844 2.028c-.787.329-1.695-.05-2.031-.84"/></svg>
			Slay the Spire 2
		</a>
	</div>
</div>
...
<style>
	...
	.os-links a.tested::after,
	.os-links a.untested::after {
		position: absolute;
		top: -0.3rem;
		right: -0.3rem;
		width: 1rem;
	...
	.os-links a[data-tooltip]::before {
	...
	.os-links a[data-tooltip]:hover::before,
	.os-links a[data-tooltip]:focus-visible::before {
		opacity: 1;
